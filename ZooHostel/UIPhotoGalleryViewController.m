...
@synthesize vPhotoGallery = vPhotoGallery;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.vPhotoGallery.layer.opacity = 0.f;
}
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [self.vPhotoGallery setInitialIndex:self.initialIndex animated:NO];
    [UIView animateWithDuration:0.2 animations:^{
        self.vPhotoGallery.layer.opacity = 1.f;
    }];
}
...
{
    [self.navigationItem setTitle:[NSString stringWithFormat:@"%d из %d", vPhotoGallery.currentIndex + 1, [self.dataSource numberOfViewsInPhotoGallery:vPhotoGallery]]];
}
...
- (void)setupBottomBar {
    ...
    UIBarButtonItem *btnPrev = [[UIBarButtonItem alloc] initWithTitle:@"     <     "
